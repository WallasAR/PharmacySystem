        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(consultaMedi)) {
            ...
            if (resultadonome.next()) {
                try (ResultSet resultado = preparedStatement.executeQuery()) {
                    ...
                    tiposmedicamentos.add("com.pharmacy.drug.TarjaPreta");
                    tiposmedicamentos.add("com.pharmacy.drug.TarjaVermelha");
                    ...
                    try (PreparedStatement preparedStatement1 = connection.prepareStatement(select1)) {
                        ...
                        try (ResultSet resultado1 = preparedStatement1.executeQuery()) {
                            while (resultado1.next()) {
                                ...
                                if (tipomedi.equalsIgnoreCase("com.pharmacy.drug.TarjaPreta") && quant > 0) {
                                    ...
                                    if (CompraRe.equalsIgnoreCase("Sim") && quant > 0) {
                                        ...
                                        System.out.println("com.pharmacy.drug.Medicamento não pode ser comprado");
                                    }
                                } else if (tipomedi.equalsIgnoreCase("com.pharmacy.drug.TarjaVermelha") && quant > 0) {
                                    int Novacompra = scanner1.nextInt();
                                    int novaquant = quant - Novacompra;
                                    float Preco = valorf * Novacompra;
                                    ...
                                    System.out.println("com.pharmacy.drug.Medicamento sem estoque, tente fazer um agendamento");
                                }
                            }
                        }
                    }
                ...
                try (ResultSet consulta = preparedStatement.executeQuery()) {
                    if (consulta.next()) {
                        do {
                            ...
                            System.out.println("Status do Pedido. ID: " + id + ", Cliente: " + nomecli + ", com.pharmacy.drug.Medicamento Comprado: " + nomemedicamento + ", Quantidade comprada: " + quantimedi + ", Valor a ser pago: " + precomedi);
                        } while (consulta.next());
                    } else {
            ...
            try (ResultSet consulta = preparedStatement.executeQuery()) {
                if (consulta.next()) {
                    do {
                        ...
                        String nomemedicamento = consulta.getString("nomemedicamento");
                        int quantimedi = consulta.getInt("quantidade");
                        System.out.println("Agendamento:  ID: " + id + ", Cliente: " + nomecli + ", com.pharmacy.drug.Medicamento Agendado: " + nomemedicamento + ", Quantidade Agendada: " + quantimedi);
                    } while (consulta.next());
                } else {
